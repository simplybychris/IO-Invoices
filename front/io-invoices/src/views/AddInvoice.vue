<template>
    <div>
        <b-modal id="addNewInvoice" title="Add Employee">
            <b-form>
                <b-form-group
                    id="input-group-1"
                    label="Employee ID:"
                ...
                >
                    ...
                    <span v-if="submitted && $v.user.id.$error" class="errorMsg"
                        >Please Enter Employee ID</span
                    >
                </b-form-group>
                <b-form-group
                    id="input-group-2"
                ...
                >
                    ...
                    <span
                        ...
                        class="errorMsg"
                        >Please Enter Employee Name</span
                    >
                </b-form-group>
                <b-form-group
                    id="input-group-3"
                ...
                >
                    ...
                    >
                        ...
                        >
                        <span v-if="$v.user.email && !$v.user.email.email"
...
export default {
    ...
    methods: {
        submitForm() {
            ...
            this.$store.dispatch('updatelistEmployee', { invoice: this.user }) // dispatch store action
        },
        resetForm() {
            this.user = {}
            this.user.isEdit = false
