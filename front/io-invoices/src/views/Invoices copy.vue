<template>
    <b-container>
        <div class="home">
            <h3 class="heading">Invoice Management System</h3>
            <div>
                <b-row>
            ...
            <div style="float: right; margin: 10px">
                <b-button size="sm" @click="addEmployee"
                    >Add New Employee</b-button
                >
            </div>
            <b-table
                striped
                hover
                :items="bindListEmployees"
                responsive="sm"
                :fields="fields"
                show-empty
...
export default {
    ...
    methods: {
        ...
        deleteEmployee(employee) {
            this.$bvModal
                .msgBoxConfirm(
                    'Please confirm that you want to delete employee.',
                    {
